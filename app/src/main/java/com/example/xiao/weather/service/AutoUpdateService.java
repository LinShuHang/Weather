package com.example.xiao.weather.service;
...
public class AutoUpdateService   extends Service {
    ...
    private  void updateWeather(){
        ...
        if(weatherString !=null){
            ...
            String weatherUrl = "http://goulin.tech/api/weather?cityid=" + weatherId + "key=https://console.heweather.com/register";
            HttpUtil.sendOkHttpRequests(weatherUrl, new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    Weather weatherData = Utility.handleWeatherResponse(responseTest);
